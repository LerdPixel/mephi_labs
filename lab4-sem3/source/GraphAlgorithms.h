...
private:
    ...
    inline Edges<TVertex, TWeight> GetOutgoingEdges(TVertex vertex) {
        return this->dictionary[vertex].GetKey();
    }
    inline Edges<TVertex, TWeight> GetIncomingEdges(TVertex vertex) {
...
template <typename TVertex, typename TWeight> 
void GraphAlgorithms<TVertex, TWeight> :: Intersection(shared_ptr<IDictionary<TVertex, bool>> note, shared_ptr<IDictionary<TVertex, bool>> comp) {
...
template <typename TVertex, typename TWeight> 
Path<TVertex, TWeight> GraphAlgorithms<TVertex, TWeight> :: Dijkstra(TVertex startVertex, TVertex finishVertex) {
...
template <typename TVertex, typename TWeight> 
shared_ptr<IDictionary<TVertex, int>> GraphAlgorithms<TVertex, TWeight> :: Coloring() {
...
template <typename TVertex, typename TWeight> 
shared_ptr<IDictionary<TVertex, bool>> GraphAlgorithms<TVertex, TWeight> :: DFS(TVertex vertex) {
...
template <typename TVertex, typename TWeight> 
shared_ptr<IDictionary<TVertex, bool>> GraphAlgorithms<TVertex, TWeight> :: ReverseDFS(TVertex vertex) {
    if (!this->ContainsVertex(vertex))
        throw std::runtime_error("Given vertex is absent");
    shared_ptr<IDictionary<TVertex, bool>> table = shared_ptr<IDictionary<TVertex, bool>>(new HashTable<TVertex, bool>(this->GetVertices(), false));
...
template <typename TVertex, typename TWeight> 
shared_ptr<IDictionary<TVertex, int>> GraphAlgorithms<TVertex, TWeight> :: StronglyConnectedComponents() { // Kosaraju's Algorithm
...
template <typename TVertex, typename TWeight>
template <typename Callable>
void GraphAlgorithms<TVertex, TWeight> :: AbstructDFS(TVertex& vertex, shared_ptr<IDictionary<TVertex, bool>> table, Callable GetEdges) {
    (*table)[vertex] = true;
